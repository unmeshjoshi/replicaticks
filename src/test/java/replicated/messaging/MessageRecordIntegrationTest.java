...
class MessageRecordIntegrationTest {
    ...
    void shouldSerializeGetRequestAsMessagePayload() throws Exception {
        ...
        Message message = new Message(client, replica, MessageType.CLIENT_GET_REQUEST, payload);
    ...
    void shouldSerializeSetRequestAsMessagePayload() throws Exception {
        ...
        Message message = new Message(client, replica, MessageType.CLIENT_SET_REQUEST, payload);
    ...
    private <T> Message createClientMessage(NetworkAddress source, NetworkAddress dest, 
        ...
        try {
            ...
            return new Message(source, dest, type, payloadBytes);
        } catch (Exception e) {
